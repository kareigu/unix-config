...
(define-kanagawa-dark-theme
 ...
 `(font-lock-string-face                         ((,class (:foreground ,fuji-white))))
 ...
 `(flycheck-inline-error                         ((,class (:foreground ,samurai-red :background ,winter-red :weight bold :height 138))))
 `(flycheck-inline-info                          ((,class (:foreground ,light-blue :background ,winter-blue :weight bold :height 138))))
 `(flycheck-inline-warning                       ((,class (:foreground ,winter-yellow :background ,carp-yellow :weight bold :height 138))))
 ...
 `(tree-sitter-hl-face:function.builtin          ((,class (:foreground ,peach-red :background ,winter-red))))
 ...
 `(tree-sitter-hl-face:property.definition       ((,class (:foreground ,old-white))))
 ...
 `(tree-sitter-hl-face:variable                  ((,class (:foreground ,spring-blue))))
 `(tree-sitter-hl-face:variable.builtin          ((,class (:foreground ,wave-red))))
 `(tree-sitter-hl-face:variable.parameter        ((,class (:foreground ,spring-violet-2))))
 ...
 `(tree-sitter-hl-face:punctuation.bracket       ((,class (:foreground ,spring-violet-2))))
 `(tree-sitter-hl-face:punctuation.delimiter     ((,class (:foreground ,spring-violet-2))))
 ...
 `(tree-sitter-hl-face:keyword.compiler          ((,class (:foreground ,peach-red))))
